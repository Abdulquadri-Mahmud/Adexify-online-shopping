    ...
    <Box className='bg-white h-[100vh]'>
      <Flex gap={0} height={'100vh'}>
        <Box position={'relative'} width={'250px'} color={'white'} p={0} height={'100%'} className='bg-white'>
          <Link to={'/'}>
            <div className="bg-green-600 text-white flex items-center gap-3 py-3 justify-center">
                <MdOutlineShoppingCart className='md:text-2xl'/>
                <h1 className='md:text-2xl font-medium'>Ade<span className="">X</span>ify</h1>
            </div>
          </Link>
          <Box pt={7} px={2}>
            <Text pl={2} fontSize={14} fontWeight={500} className='text-green-400'>Main Menu</Text>
            <Box mt={6}>
              <Box>
                <Link to={'/admin-dashboard'}>
                  <Flex py={2} pl={5} color={'white'} rounded={'md'}  alignItems={'center'} gap={2} className='duration-200 hover:bg-green-600 hover:text-white  bg-green-600  text-white'>
                    <FiGrid className='text-xl text-green-600'/>
              ...
              <Box mt={5}>
                <Link to={'/admin/create-products'}>
                  <Flex py={2} pl={5} color={'black'} rounded={'md'}  alignItems={'center'} gap={2} className='duration-200 hover:bg-green-600 hover:text-white'>
                    <FaStore className='text-xl text-green-600 hover:text-white'/>
              ...
              <Box mt={5}>
                <Link to={'/'}>
                  <Flex py={2} pl={5} color={'black'} rounded={'md'}  alignItems={'center'} gap={2} className='duration-200 hover:bg-green-600 hover:text-white'>
                    <MdOutlineShoppingCart className='text-xl text-green-600 hover:text-white'/>
              ...
              <Box mt={5}>
                <Link to={'/'}>
                  <Flex py={2} pl={5} color={'black'} rounded={'md'}  alignItems={'center'} gap={2} className='duration-200 hover:bg-green-600 hover:text-white'>
                    <FaUsersLine className='text-xl text-green-600 hover:text-white'/>
              ...
              <Box mt={5}>
                <Link to={'/'}>
                  <Flex py={2} pl={5} color={'black'} rounded={'md'}  alignItems={'center'} gap={2} className='duration-200 hover:bg-green-600 hover:text-white'>
                    <BsBank2 className='text-xl text-green-600 hover:text-white'/>
          ...
          <Box pos={'absolute'} bottom={0} width={'full'}>
            <button className='py-2 bg-green-600 text-white w-[94%] uppercase font-medium'>Logout</button>
          </Box>
        </Box>
            ...
            <Box className='flex gap-2'>
              <Box p={4} width={'300px'} height={'300px'} bg={'white'} rounded={'md'}>
                ...
                <Box pt={14} className='flex justify-center items-center'>
                  <CircularProgress value={40} color='green.500' size={'160px'} className='text-green-600'>
              ...
              <Box className='flex flex-col gap-4'>
                <Box p={4} width={{md:'250px'}} rounded={'md'} bg={'white'} height={'140px'}>
                  ...
                  <Box pt={3}>
                    <Heading textAlign={'center'} fontWeight={500} className='font-medium flex justify-center items-center text-green-600'><FaNairaSign className='text-2xl'/>0</Heading>
              ...
              <Box className='flex flex-col gap-4'>
                <Box p={4} width={{md:'250px'}} rounded={'md'} bg={'white'} height={'140px'}>
                  ...
                  <Box pt={3}>
                    <Heading textAlign={'center'} fontWeight={500} className='font-medium flex justify-center items-center text-green-600'>{users.length}</Heading>
                ...
                <Box p={4} width={{md:'250px'}} rounded={'md'} bg={'white'} height={'140px'}>
                  ...
                  <Box pt={3}>
                    <Heading textAlign={'center'} fontWeight={500} className='font-medium flex justify-center items-center text-green-600'>{products.length}</Heading>
              ...
              <Box className='flex flex-col gap-4'>
                <Box p={4} width={{md:'250px'}} rounded={'md'} bg={'white'} height={'140px'}>
                  ...
                  <Box pt={3}>
                    <Heading textAlign={'center'} fontWeight={500} className='font-medium flex justify-center items-center text-green-600'>{female.length}</Heading>
                ...
                <Box p={4} width={{md:'250px'}} rounded={'md'} bg={'white'} height={'140px'}>
                  ...
                  <Box pt={3}>
                    <Heading textAlign={'center'} fontWeight={500} className='font-medium flex justify-center items-center text-green-600'>{male.length}</Heading>
                    <Text pt={3 } fontSize={12} className='flex items-center gap-1 text-gray-400'>Total women fashion wear</Text>
                  </Box>
                </Box>
              </Box>
            ...
            <Box mt={6} width={{md: '100%'}}>
              <Heading fontWeight={500} fontSize={20}>Customers</Heading>
                <Box mt={3} color={'black'} rounded={'md'} className='bg-white'>
                  <TableContainer>
                    <Table>
                      <Thead className='bg-green-600 rounded-md'>
                        <Tr>
