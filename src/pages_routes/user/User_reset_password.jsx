...
export default function User_reset_password() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const end_point = `https://adexify-api.vercel.app/api/user/auth/reset-password/${token}`;
        ...
        <Box py={20} className='bg-zinc-100'>
            <Box maxW={'350px'} mx={'auto'} py={5} px={3} bg={'white'} rounded={'md'}>
                ...
                <Flex justifyContent={'center'} mt={2}>
                    <Link to={'/signin'} className='text-pink-600 text-[13px] pt-3 text-center'>Back To Signin</Link>
                </Flex>
            </Box>
        </Box>
    </Box>
