...
export default function Mens_wear_products() {
  ...
  return (
    <div className='relative bg-white p-2 rounded-xl shadow-md '>
        ...
        <button onClick={handleWishlistItem} className=" text-white cursor-pointer hover:text-green-500 active:text-green-500 focus:text-green-500 absolute top-2 right-2 w-[30px] h-[30px] bg-gray-300 flex justify-center items-center rounded-full">
