...
import { addToCart, clearCart, clearError, clearSuccess, } from '../../store/cart/cartSlice';
...
export default function Women_Clothing() {
  const product = useContext(Women_ClothingContext);
    ...
    return (
        <Box key={product._id} position="relative" borderWidth="1px" borderColor={'gray.100'} borderRadius="xl" p={2} bg="white">
