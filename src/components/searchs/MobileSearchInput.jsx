  ...
  return (
    <Box position="relative" display="flex" justifyContent="center">
      ...
      <Box pos={'relative'}  onClick={handleToggle} zIndex={20}>
        <Box p="2px" borderRadius="full" bg="white" display="flex" justifyContent="center" alignItems="center" cursor="pointer" shadow="lg" transition="all 0.2s ease" _hover={{ transform: "scale(1.05)", shadow: "xl" }}>
