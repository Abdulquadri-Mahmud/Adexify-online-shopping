...
export const ShoesProductsContext = createContext();
...
export default function Shoes() {
  ...
  return (
    <Box mt={7} maxW={{'2xl' : '80%', xl : '95%', lg : '100%', base: '97%'}} mx={'auto'} className='md:mb-0 mb-0 bg-white rounded-lg'>
        <Box borderBottomWidth={'1px'} borderBottom={'solid gray.300'} pb={3} className='bg-white-500 py-3 rounded-t-lg px-3 text-white'>
              ...
              currentPost.map((product) => (
                product.deal === 'great' ? (
                  <Box key={product._id} p={1} shadow={'md'}>
                    <ShoesProductsContext.Provider value={product}>
                        <Shoe product={product}/>
                    </ShoesProductsContext.Provider>
                  </Box>
                ) : ''
              ))
          }
