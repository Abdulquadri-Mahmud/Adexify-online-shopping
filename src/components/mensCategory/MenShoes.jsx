...
import { UnderwearContext } from '../../pages/Mens_Clothing/Underwear_page';
import { MenShoesContext } from '../../pages/Mens_Clothing/Men_Shoes_page';

export default function MenShoes() {
  const product = useContext(MenShoesContext);
