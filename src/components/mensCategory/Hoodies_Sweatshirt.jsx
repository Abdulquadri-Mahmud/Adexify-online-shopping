...
import { Hoodies_SweatshirtContext } from '../../pages/Mens_Clothing/Hoodies_sweatshirt_page';

export default function Hoodies_Sweatshirt() {
  const product = useContext(Hoodies_SweatshirtContext);
