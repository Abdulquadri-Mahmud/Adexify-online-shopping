...
export default function ContactUs() {
  return (
    <Box>
        <Header/>
        <Box pb={'4vh'} className='bg-zinc-100'>
            <Box className="bg-whit  p-2 ">
                <Box maxW={{'2xl' : '80%', xl : '90%', lg : '97%', base: '97%'}} mx={'auto'} className="flex gap-1 items-center">
            ...
            <Box bg={'white'} mt={4} maxW={{'2xl' : '80%', xl : '90%', lg : '97%', base: '97%'}} mx={'auto'} rounded={'10px'} shadow={'md'} p={{md: 5, base:3}}>
                <Box className="mt-2">
                    <Heading textAlign={'center'} fontSize={{md:30, base: 25}} fontWeight={500} color={'black'}>Connect With Us</Heading>
                </Box>
                <Flex justifyContent={'center'} flexWrap={'wrap'} mt={'5vh'} bg={'white'} gap={5}>
                    <Box width={{md: '45%', base: '100%'}}>
                        ...
                        <Flex alignItems={'center'} justifyContent={'center'} gap={5} mt={5}>
                            <Box className="w-9 h-9 bg-pink-200 rounded-full hover:bg-pink-300 duration-200 cursor-pointer flex justify-center items-center text-pink-600">
                                <Link to={'/'}>
                                    <FaFacebookF className='text-xl'/>
                                </Link>
                            </Box>
                            <Box className="w-9 h-9 bg-pink-200 rounded-full hover:bg-pink-300 duration-200 cursor-pointer translate-y-5 flex justify-center items-center text-pink-600">
                                <Link to={'/'}>
