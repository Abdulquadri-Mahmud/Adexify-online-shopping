...
export const UnderwearContext = createContext();

const Underwear = React.lazy(() => import('../../components/mensCategory/Underwear'));

// Main Component
export default function Underwear_page() {
  const clothingLinks = [
  ...
  const filteredProducts = products.filter((product) => {
    ...
    filter === 'All' ? product.gender === 'male' && product.category === 'Underwear' : product.category === filter && product.gender === 'male';
                ...
                {currentProducts.length > 0 ? (
                  currentProducts.map((product) => (
                    <Suspense fallback={<Loading/>}>
                      <UnderwearContext.Provider value={product}>
                        <Underwear key={product._id} product={product} />
                      </UnderwearContext.Provider>
                    </Suspense>
                  ))
                ) : (
