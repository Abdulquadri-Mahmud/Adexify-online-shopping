...
export const SandalsContext = createContext();

const Sandals = React.lazy(() => import('../../components/mensCategory/Sandals'));

// Main Component
export default function Sandals_page() {
  const clothingLinks = [
  ...
  const filteredProducts = products.filter((product) => {
    ...
    filter === 'All' ? product.gender === 'male' && product.category === 'Sandals' : product.category === filter && product.gender === 'male';
                ...
                {currentProducts.length > 0 ? (
                  currentProducts.map((product) => (
                    <Suspense fallback={<Loading/>}>
                      <SandalsContext.Provider value={product}>
                        <Sandals key={product._id} product={product} />
                      </SandalsContext.Provider>
                    </Suspense>
                  ))
                ) : (
