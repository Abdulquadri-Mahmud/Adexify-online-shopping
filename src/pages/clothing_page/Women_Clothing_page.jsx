...
export default function Women_Clothing_page() {
  ...
  return (
    <Box className='bg-zinc-200'>
      ...
      {renderSection('Top Picks', Women_ClothingContext, Women_Clothing, product => (product.gender === 'female' || product.gender === 'femail') && product.price >= 4000)}
      <Home_banner4 />
      {renderSection('Top Bags', TopBags_Context, TopBags, product => product.gender === 'female' && product.category === 'Bags')}
      {renderSection('Top Jewelleries', TopJewellery_Context, TopJewellery, product => product.gender === 'female' && product.category === 'Jewellery')}
      <Home_banner4/>
      {renderSection('Top Clothes', TopShirts_Context, TopShirts, product => product.gender === 'female' && product.category === 'Shirt')}
      {renderSection('Top Shoes', TopShoes_Context, TopShoes, product => product.gender === 'female' && product.category === 'Shoes')}
